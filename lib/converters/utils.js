 ...
 * @param {Object} obj ioBroker object, used to read id, name, icon, unit, lovelace2 specific settings.
 * @param {string} entityType lovelace2 domain of entity, for example light, sensor, ...
